...
<div class="container-fluid tophead howtop">
   <div class="row">
      <div class="col-lg-2 lefthead1">
      </div>
      <div class="col-lg-4 lefthead">
         <p>HOW IT WORKS</p>
         <h2>The three profiles and the four features works 
            together in a symbiosis, where they enhance 
            each other through 
            synergy effects.
         </h2>
      </div>
      <div class="col-lg-6 righthead">
      </div>
   </div>
</div>
...
<div class="container-fluid starter123 top_start howstart"  id="strengthdiv">
   <div class="row">
      ...
      <div class="col-lg-1 mt-4 numbe1">
         <img src="images/hownum1.png" class="img-fluid roundimg">
      </div>
      <div class="col-lg-4 pl-5 mobnumbg" align="left">
         <p>STRENGTH ATHLETE</p>
         <h2>Search & find programs</h2>
         <h5>Find the most optimal programs for you throgh search in the Program designs or Experience banks sections. Upload the desired program to your own Calendar & training log. </h5>
      </div>
   </div>
</div>
<div class="container-fluid starter123">
   <div class="row">
      ...
      <div class="col-lg-4 pl-5" align="left">
         <p>STRENGTH ATHLETE</p>
         <h2>Start training</h2>
         <h5>Start the training program by logging each session on your cell phone. Your workload will automatically adjust on a set-to-set basis, depending on your current fatigue level.</h5>
      </div>
   </div>
</div>
<div class="container-fluid starter123 top_start1">
   <div class="row">
      ...
      <div class="col-lg-4 pl-5" align="left" >
         ...
         <h5>Complete the program and get your results analyzed, by comparing your results with the Strength standards 
            and Experience banks. Learn what program designs that suits you best. 
         </h5>
      </div>
   </div>
</div>
<div class="container-fluid secstarter123 top_start" id="programdiv">
   <div class="row">
      ...
      <div class="col-lg-1 pl-0 pr-0 mt-4 numbe1">
         <img src="images/hownum2.png" class="numimg">
      </div>
      <div class="col-lg-4 pl-5 mobnumbg1" align="left">
...
<div class="container-fluid secstarter123">
   <div class="row">
      ...
      <div class="col-lg-4 pl-5" align="left">
         <p>PROGRAM DESIGNER</p>
         <h2>Get feedback</h2>
         <h5>Get objective feedback on how well different strength athletes responds to your program. Get subjective feedback from strength athletes like reviews and comments on your newsfeed.  </h5>
      </div>
   </div>
</div>
<div class="container-fluid secstarter123 top_start1">
   <div class="row">
      ...
      <div class="col-lg-4 pl-5" align="left">
         ...
         <h5>Learn how your theoretical program works in practise, and use your gained insight and knowlegde to build even better programs. Use our learn more section to master the fundamental strength training principles.   </h5>
      </div>
   </div>
</div>
<div class="container-fluid thirdstarter123 top_start" id="personaldiv">
   <div class="row">
      ...
      <div class="col-lg-4 pl-5 mobnumbg2" align="left">
